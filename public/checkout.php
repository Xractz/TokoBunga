    ...
    <div class="container checkout-layout">
      <section class="checkout-left">
        ...
        <div class="checkout-card">
          ...
          <div class="checkout-row-2">
            <div class="checkout-field">
              <label for="fullName" class="checkout-label">Example Recipient Name <span>*</span></label>
              <input
                id="fullName"
                type="text"
            ...
            <div class="checkout-field">
              <label for="phone" class="checkout-label">Phone Number <span>*</span></label>
              <input
                id="phone"
                type="tel"
                class="checkout-input"
        ...
        <div class="checkout-card">
          ...
          <div class="checkout-field">
            <label for="address" class="checkout-label">Street Address <span>*</span></label>
            <input
              id="address"
              type="text"
              class="checkout-input"
          ...
          <div class="checkout-row-3">
            <div class="checkout-field">
              <label for="city" class="checkout-label">City <span>*</span></label>
              <input id="city" type="text" class="checkout-input" placeholder="City" />
            </div>

            <div class="checkout-field">
              <label for="province" class="checkout-label">Province <span>*</span></label>
              <input id="province" type="text" class="checkout-input" placeholder="Province" />
            </div>

            <div class="checkout-field">
              <label for="postal" class="checkout-label">Postal Code</label>
        ...
        <div class="checkout-card">
          ...
          <div class="checkout-field">
            <label for="notes" class="checkout-label">Message for the card (Optional)</label>
            <textarea
              id="notes"
              class="checkout-textarea"
              rows="3"
              placeholder="Happy Birthday! Love, ..."></textarea>
          </div>
        </div>
      </section>
